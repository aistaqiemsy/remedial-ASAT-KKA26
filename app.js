...
,
  {
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Bagian 1 dijelaskan secara mandiri dan ringkas. Bagian 2 menyusun prompt RTCC cukup baik mengenai konfigurasi Mikrotik.",
    feedback: "Pemahaman etika dan cara kerja AI sudah cukup baik. Pertahankan penulisan prompt terstruktur dan terus latih kemampuan analisis kritis terhadap hasil AI."
  },
  {
    nis: "12510798",
    jurusan: "DKV X-1",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Penjelasan etika AI baik dan orisinal. Prompt presentasi DKV memuat perincian slide yang jelas.",
    feedback: "Analisis etika dan rancangan prompt DKV kamu sangat rapi dan relevan. Tingkatkan lagi evaluasi mandiri pada revisi prompt."
  },
  {
    nis: "12510990",
    jurusan: "DKV X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Bagian 1 menggunakan bahasa sendiri yang sederhana. Bagian 2 menyusun prompt presentasi desain namun evaluasi revisi masih agak umum.",
    feedback: "Penjelasan pemahaman etika sudah bagus. Untuk prompt engineering, usahakan menambahkan instruksi gaya visual yang lebih spesifik."
  },
  {
    nis: "12511221",
    jurusan: "DKV X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Bagian 1 dan Bagian 2 sangat lengkap memuat rancangan PPT 3D Modeling DKV dengan aksen neon dan wireframe. Evaluasi revisi visual sangat konkret.",
    feedback: "Luar biasa! Prompt 3D Modeling kamu sangat terstruktur dan detail. Pemahaman etika juga disampaikan dengan bahasa sendiri yang kuat."
  },
  {
    nis: "12510925",
    jurusan: "DKV X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Penjelasan etika singkat dan mandiri. Prompt presentasi cukup terstruktur untuk audiens siswa SMK DKV.",
    feedback: "Jawaban etika sudah bagus dan jujur. Cobalah untuk memperdalam aspek evaluasi saat merevisi prompt AI."
  },
  {
    nis: "12510902",
    jurusan: "DKV X-1",
  ...
  },
  {
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Pengerjaan bagian etika dan prompt mandiri, bahasa sederhana dan sesuai pemahaman murid SMK.",
    feedback: "Hasil pengerjaan remedial kamu sudah baik dan orisinal. Tingkatkan detail pada instruksi batasan/constraint prompt."
  },
  {
    nis: "12510870",
    jurusan: "DKV X-2",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Jawaban etika logis. Prompt presentasi DKV memuat konteks yang relevan.",
    feedback: "Sangat baik! Etika penggunaan AI disampaikan dengan lugas. Terus eksplorasi penggunaan AI sebagai alat bantu ideasi."
  },
  {
    nis: "12510833",
    jurusan: "DKV X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Penjelasan etika sangat terperinci mengenai tokenisasi AI. Prompt presentasi peran AI dalam DKV memuat 9 ketentuan komprehensif.",
    feedback: "Sangat bagus! Pemahaman teori etika AI dan kejelasan instruksi prompt kamu sangat mendalam dan terstruktur."
  },
  {
    nis: "12510896",
    jurusan: "DKV X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Bagian 1 dijawab dengan bahasa sendiri. Prompt bagian 2 menyebutkan penggunaan AI untuk referensi desain.",
    feedback: "Pemahaman etika sudah memadai. Usahakan untuk memperjelas revisi prompt agar output AI lebih spesifik."
  },
  {
    nis: "12511109",
    jurusan: "TJKT X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Jawaban etika dan penggunaan AI etis cukup orisinal. Prompt jaringan TJKT dapat dipahami.",
    feedback: "Penjelasan etika sudah baik. Latihlah penggunaan teknik RTCC (Role, Task, Context, Constraint) pada prompt."
  },
  {
    nis: "12511092",
    jurusan: "TJKT X-2",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Penjelasan etika AI menyebutkan ketergantungan dan hoaks secara tepat. Prompt jaringan disusun rapi.",
    feedback: "Hasil analisis etika kamu orisinal dan realistis. Selamat, penggunaan prompt untuk bidang TJKT sudah cukup baik."
  },
  {
    nis: "12510782",
    jurusan: "TJKT X-1",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Penjelasan cara kerja AI dan risiko halusinasi sangat baik. Prompt cybersecurity terstruktur.",
    feedback: "Sangat baik! Kamu memahami risiko AI serta cara memanfaatkan AI secara etis dan produktif di jurusan TJKT."
  },
  {
    nis: "12511125",
    jurusan: "TJKT X-2",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Jawaban etika ringkas dan lugas. Prompt dasar-dasar IT sudah sesuai materi kelas X.",
    feedback: "Pemahaman etika AI kamu sudah cukup baik. Cobalah untuk memperjelas konteks audiens pada prompt selanjutnya."
  },
  {
    nis: "12510842",
    jurusan: "TJKT X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Menjelaskan risiko ketergantungan dan halusinasi AI dengan baik. Prompt jaringan terstruktur.",
    feedback: "Analisis etika AI kamu sudah bagus. Pertahankan gaya penulisan prompt yang jelas dan fokus pada tujuan praktis."
  },
  {
    nis: "12510972",
    jurusan: "TJKT X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Pemahaman etika AI logis. Prompt pembuatan outline Mikrotik disusun cukup lengkap.",
    feedback: "Bagus sekali! Penggunaan AI sebagai asisten belajar TJKT sudah tepat tanpa melakukan plagiarisme total."
  },
  {
    nis: "12511104",
    jurusan: "TJKT X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Penjelasan manfaat dan risiko AI ditulis mandiri. Prompt jaringan dasar memuat instruksi yang jelas.",
    feedback: "Pemahaman etika penggunaan AI kamu sudah baik. Terus tingkatkan kejelasan instruksi pada prompt."
  },
  {
    nis: "12511101",
    jurusan: "TJKT X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Bagian etika dikerjakan mandiri dalam poin sederhana. Prompt singkat namun relevan.",
    feedback: "Jawaban kamu orisinal. Disarankan untuk memberikan perincian lebih pada bagian evaluasi prompt."
  },
  {
    nis: "12511166",
    jurusan: "TJKT X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Jawaban etika AI runtut dan jujur. Prompt materi jaringan komputer disusun dengan bahasa yang baik.",
    feedback: "Pemahaman etika AI kamu sudah mantap. Pertahankan cara penggunaan AI yang bijak sebagai alat bantu."
  },
  {
    nis: "12510940",
    jurusan: "TJKT X-2",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Pengerjaan bagian 1 logis. Prompt bagian 2 memuat topik IT/jaringan sesuai jurusan TJKT.",
    feedback: "Penjelasan etika AI sudah baik. Cobalah untuk menambahkan batasan jumlah slide atau panjang output pada prompt."
  },
  {
    nis: "12511142",
    jurusan: "TJKT X-1",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Pemahaman etika disampaikan dengan jelas. Prompt materi jaringan memuat perintah awal dan revisi yang baik.",
    feedback: "Sangat baik! Terus kembangkan pemahaman etika AI dan teknik prompt engineering untuk mendukung keahlian TJKT."
  },
  {
    nis: "12511076",
    jurusan: "TJKT X-2",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Jawaban etika AI natural. Prompt presentasi jaringan komputer terstruktur dengan jelas.",
    feedback: "Hasil remedial kamu sudah baik. Pertahankan kejujuran akademik dan pemanfaatan AI secara bertanggung jawab."
  },
  {
    nis: "12511217",
    jurusan: "TJKT X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Sangat baik! Jawaban etika terperinci (memuat verifikasi data, batasan ideasi). Prompt Keamanan Jaringan RTCC memuat evaluasi penggantian Snort ke Mikrotik yang amat kritis.",
    feedback: "Luar biasa! Analisis etika dan daya kritis kamu terhadap hasil AI (menyesuaikan Snort ke Mikrotik) sangat impresif dan matang."
  },
  {
    nis: "12511064",
    jurusan: "TJKT X-3",
  ...
  },
  {
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Penjelasan etika logis (menyebutkan isu hoax AI). Prompt Ransomware sangat terstruktur dengan analogi dunia nyata untuk audiens non-teknis.",
    feedback: "Sangat baik! Prompt penjelasan Ransomware kamu dengan analogi eksekutif non-teknis menunjukkan pemahaman komunikasi IT yang tinggi."
  },
  {
    nis: "12511188",
    jurusan: "TJKT X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Salin Panduan",
    catatanDeteksi: "Bagian 1 dijawab singkat. Bagian 2 menyertakan link netlify pada kolom revisi prompt.",
    feedback: "Pemahaman etika sudah cukup. Pada bagian prompt engineering, pastikan menuliskan teks perintah revisi secara langsung, bukan hanya link."
  },
  {
    nis: "12510900",
    jurusan: "TJKT X-1",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Jawaban etika singkat. Prompt outline konfigurasi router Mikrotik untuk pemula disajikan dengan baik.",
    feedback: "Pemahaman etika sudah cukup. Prompt Mikrotik kamu sudah bagus, tingkatkan lagi detail pada instruksi revisinya."
  },
  {
    nis: "12511179",
    jurusan: "TJKT X-1",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Salin Panduan",
    catatanDeteksi: "Penjelasan etika AI baik (profesi AI Data Analyst). Prompt awal Cybersecurity sangat detail, namun kolom revisi melampirkan link Google Drive.",
    feedback: "Pemahaman etika dan prompt awal kamu sangat bagus. Untuk evaluasi berikutnya, cantumkan teks ringkasan perubahan prompt secara tertulis."
  },
  {
    nis: "12511177",
    jurusan: "TJKT X-3",
    ...
    kategoriEtika: "Murni Murid",
    kategoriPrompt: "Murni Murid",
    catatanDeteksi: "Penjelasan etika komprehensif (pengajar virtual & privasi data). Prompt materi TKJ terstruktur dengan evaluasi revisi kelas & warna PPT.",
    feedback: "Sangat baik! Penjelasan etika komprehensif dan prompt jaringan komputer kamu disusun secara lengkap dan terstruktur."
  }];
